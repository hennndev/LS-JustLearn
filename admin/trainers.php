                        ...
                        <tbody>
                            <?php foreach($trainers as $key => $trainer): ?>    
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap space-x-3">
                                        <a href="/justlearn/admin/edit-trainer.php?id=<?= $trainer["id"] ?>" class="text-blue-500 font-medium hover:underline">Edit</a>
                                        <a href="/justlearn/admin/delete-trainer.php?id=<?= $trainer["id"] ?>" class="text-red-500 font-medium hover:underline" onclick="return confirmDelete()">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
